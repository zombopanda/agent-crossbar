# Provider Usage Telemetry Specification

## Purpose

Defines provider-native token usage reporting and truthful completeness metadata
for terminal job results consumed by operators and downstream integrations.
